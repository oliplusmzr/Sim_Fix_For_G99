## Version Carmine Released!
* Mobile data issue fixed.
* Issues with phone calls fixed.
* Unnecessary lines and bugs in the code structure fixed.



## Version Orange Released!
* Bugs Fixed
